...
<header class="site-header" data-header>
	...
	<nav class="mobile-menu" id="mobile-menu" aria-label="<?php esc_attr_e( 'Menu mobile', 'lumiere-du-monde' ); ?>" data-mobile-menu>
		<a href="#home">Accueil</a><a href="#luminaires">Luminaires</a><a href="#table">Art de la table</a><a href="#maison">La maison</a><a href="#abidjan">Nous trouver</a><a href="#contact">Contact</a>
	</nav>
	</header>
