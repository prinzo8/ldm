...
?>
	<aside class="ldm-cart"
        data-cart-drawer
        aria-hidden="true">

    <button type="button"
            class="ldm-cart__close cart-cursor-black"
            data-cart-close
            aria-label="Fermer le panier">×</button>

    <div class="ldm-cart__inner">
        <p class="eyebrow">Votre sélection</p>
        <h2>Votre panier</h2>

        <div class="ldm-cart__items" data-cart-items>
				<div class="cart-items-list" data-cart-items-list aria-live="polite"></div>
			</div>

        <div class="ldm-cart__footer">
            <strong data-cart-total>0</strong>
            <button type="button"
                    class="button button--dark cart-cursor-black"
                    data-cart-checkout>
                Voir le panier
            </button>
        </div>
...
<button type="button"
    ...
    <svg class="ldm-cart-trigger__icon"
         aria-hidden="true"
         viewBox="0 0 24 24"
         fill="none"
         stroke="currentColor"
...
<div class="product-modal" data-product-modal aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="product-modal-title">
	...
	<div class="product-modal__sheet" role="document">
		...
		<div class="product-modal__image-wrap"><img src="" alt="" data-modal-image></div>
			<div class="product-modal__content"><p class="eyebrow" data-modal-category></p><p class="product-number" data-modal-number></p><h2 id="product-modal-title" data-modal-name></h2><p class="product-modal__description" data-modal-description></p><dl><div><dt>Prix</dt><dd data-modal-price></dd></div><div><dt>Disponibilité</dt><dd data-modal-availability></dd></div></dl><div class="product-modal__cart-controls" data-modal-cart-controls>
    <button type="button"
            class="product-modal__cart-button cart-cursor-black"
            data-modal-cart-minus
            aria-label="Retirer un exemplaire">−</button>

    <span class="product-modal__cart-quantity cart-cursor-black"
          data-modal-cart-quantity
    ...
    <button type="button"
            class="product-modal__cart-add button button--dark cart-cursor-black"
            data-modal-cart-add-product>
        Ajouter au panier
    </button>
</div></div>
	</div>
